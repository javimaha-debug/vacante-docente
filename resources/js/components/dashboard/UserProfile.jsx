        ...
        <form onSubmit={handleSubmit} className="mx-auto max-w-2xl space-y-6">
            <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-6">
                ...
                <p className="mt-1 text-sm text-slate-500">
                    Estos datos personalizan tu panel y los cálculos de distancia.
                </p>
                ...
                <div className="mt-5 space-y-5">
                    <div>
                        ...
                        <p className="mt-1 text-xs text-slate-400">
                            Escríbelo en el formato <span className="font-semibold">APELLIDO1 APELLIDO2, NOMBRE</span>{' '}
                            tal y como aparece en los documentos de la GVA.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => update('direccion_origen', e.target.value)}
                            placeholder="Carrer, número, localidad"
                            className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-brand-400 focus:ring-brand-400"
                        />
                        <p className="mt-1 text-xs text-slate-400">
                            Se geolocaliza para calcular distancias a los centros.
                        </p>
                    </div>
                    ...
                    <Toggle
                        ...
                        onChange={(v) => update('notificaciones_email', v)}
            ...
            <div className="flex items-center gap-3">
                ...
                {mutation.isError && (
                    <span className="text-sm text-red-600">{mutation.error?.friendlyMessage}</span>
                )}
            </div>
        </form>
    );
